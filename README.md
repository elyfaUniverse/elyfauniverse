# 👋 Привет, я Элина Дудий

### Data Scientist | Data Engineer | ML Engineer | Аналитик
...
![Tilda](https://img.shields.io/badge/Tilda-FF5A5F?style=for-the-badge)

### 📐 Математическая база
![Математический анализ](https://img.shields.io/badge/Математический%20анализ-4A90E2?style=for-the-badge)
![Линейная алгебра](https://img.shields.io/badge/Линейная%20алгебра-7B68EE?style=for-the-badge)
...
**Сайт:** [universelyfa.ru](https://universelyfa.ru/)  
**Период:** Текущий проект  
**Обязанности:**
...
**Специальность:** Магистр компьютерных наук  
**Направление:** Прикладная математика и информатика  
**Год окончания:** 2027  
**Статус:** В процессе обучения

### 🏛️ Уфимский государственный нефтяной технический университет (УГНТУ)
...
**Специальность:** Специалист по работе с системами искусственного интеллекта  
**Год окончания:** 2025
...
### 🍎 "Умный бюджет: планировщик питания для студентов"
Мобильное приложение, которое:
- Анализирует цены на продукты в ближайших магазинах
- Формирует оптимальное меню на месяц в рамках заданного бюджета
- Помогает студентам и людям с ограниченным доходом питаться сбалансированно и экономично

### 📊 Исследование влияния социальных факторов
Проект на стыке социологии, Data Science и ML:
- Анализ влияния образования, окружения, потребляемого контента на профессиональный выбор
- Исследование взаимосвязи социальных факторов с уровнем дохода и жизненными решениями
- Применение методов машинного обучения для выявления закономерностей

---

## 🌟 Обо мне

Мой путь в сфере технологий начался с инженерного образования, а затем продолжился в магистратуре по прикладной математике и информатике. Стремлюсь к постоянному развитию в области больших данных и созданию полезных технологических решений.

### Soft Skills:
- Умение разбираться в сложных системах
- Опыт самостоятельного изучения программирования
- Интерес к новым технологиям и смежным областям
- Понимание полного цикла разработки: от идеи до прототипа
- Опыт работы с данными из разных источников
...
- **[Ссылка на проект](https://github.com/elyfaUniverse/project_n8n)**
